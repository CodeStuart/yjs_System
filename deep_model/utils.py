...
from deep_model.conlleval import return_report
...
#sess, Model, FLAGS.ckpt_path, load_word2vec, config, id_to_char, logger
...
def bio_to_json(string, tags):
    ...
    for c_idx in range(len(tags)):
        ...
        iCount += 1
    return item
# convert_single_example(char_line=text,tag_to_id=tag_to_id,max_seq_length=max_seq_length,tokenizer=tokenizer,label_line=labels)
