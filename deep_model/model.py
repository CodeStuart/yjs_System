...
import deep_model.rnncell as rnn
from deep_model.utils import bio_to_json
from deep_model.bert import modeling
import os
...
class Model(object):
    def __init__(self, config):
        ...
        self.lengths = tf.cast(length, tf.int32)#True lengths
        ...
        # bert模型参数初始化的地方
        init_checkpoint = "deep_model/chinese_L-12_H-768_A-12/bert_model.ckpt"
        # 获取模型中所有的训练参数。
    ...
    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file("deep_model/chinese_L-12_H-768_A-12/bert_config.json")  # 配置文件地址。
        ...
        embedding = model.get_sequence_output()#[Batch_size * seq_size * embdding_size]
        return embedding
    ...
    def create_feed_dict(self, is_train, batch):
        ...
        feed_dict = {
            self.input_ids: np.asarray(chars),#bert
